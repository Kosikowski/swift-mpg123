...
/* Define the package library directory */
#define PKGLIBDIR "/usr/local/lib/mpg123"

/* Define to use float arithmetic for real numbers */
#define REAL_IS_FLOAT 1

/* Define FIR buffer size for synthesis */
#define FIR_BUFFER_SIZE 1024
#define FIR_SIZE 16
...
#define PACKAGE_STRING "mpg123 1.33.0"
